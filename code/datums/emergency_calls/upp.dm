...
/datum/emergency_call/upp/print_backstory(mob/living/carbon/human/M)
	if(ishuman_strict(M))
		...
		to_chat(M, role_body("Throughout your career, your engineers, and later, your UPP compatriots, treated you like [pick(75;"a tool, and only that.", 25;"a person, despite your purpose.")]"))
	...
	to_chat(M, role_body("With the recent arrival of the USCM battalion the 'Falling Falcons' and their flagship, the [MAIN_SHIP_NAME], the UPP has felt threatened in the sector."))
	if(hostility)
		...
		to_chat(M, role_body("Despite this, the leadership of your battalion questions what may have prompted the distress signal from their rivals. Your squad is to find out why and to render aid to the beleaguered UA forces."))
